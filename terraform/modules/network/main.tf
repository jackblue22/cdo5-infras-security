...
resource "aws_subnet" "public" {
  for_each = {
    for index, az in var.azs : az => var.public_subnet_cidrs[index]
  }
...
resource "aws_subnet" "private" {
  for_each = {
    for index, az in var.azs : az => var.private_subnet_cidrs[index]
  }
...
resource "aws_vpc_endpoint" "interface" {
  ...
  tags = {
    Name = "${var.name_prefix}-${replace(replace(each.value, "com.amazonaws.${var.aws_region}.", ""), ".", "-")}-vpce"
  }
}
